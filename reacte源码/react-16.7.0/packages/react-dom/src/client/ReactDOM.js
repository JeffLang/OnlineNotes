 ...
 *
 * @param {*} container 根节点
 * @param {*} isConcurrent 首次root节点渲染为false
 * @param {*} hydrate 客户端渲染为false
 */
function ReactRoot(
  container: Container,
...
/**
 *
 * @param {*} container 容器节点 根节点
 * @param {*} forceHydrate 是否复用原来有的节点 一般服务端渲染使用true 客户端渲染使用false
 * @returns
 */
...
const ReactDOM: Object = {
  ...
  /**
   * hydrate 和 render方法 是否会调和原来的节点 一般使用hydrate
   * @param {*} element
   * @param {*} container
   * @param {*} callback
   * @returns
  ...
  /**
   *
   * @param {*} element  App react的第一个组件
   * @param {*} container 原生根节点
   * @param {*} callback 渲染之后的回调函数
   * @returns
   */
  render(
